...
| 07 | Weight Converter | 🔗 [Live Demo](https://mr-syntax1.github.io/50-mini-web-apps/07-react-information) |
| 08 | ... | (coming soon) |
| 09 | ... | (coming soon) |
...
Not “just tutorials” — but **applied front-end power**:
- DOM control
- browser API usage
- UI logic
...
Every mini app is focused on **1 concept** → small, sharp, and practical.
